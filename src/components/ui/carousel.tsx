  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn(
          "overflow-hidden",
          orientation === "horizontal" && "touch-pan-y",
        )}
      >
        <div
          ref={ref}
...
const CarouselDots = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  ...
  return (
    <div
      className={cn("flex justify-center items-center gap-1.5 pt-6", className)}
      role="tablist"
    ...
    >
      {Array.from({ length: snapCount }, (_, i) => (
        <button
          ...
          aria-label={`Review ${i + 1} of ${snapCount}`}
          className={cn(
